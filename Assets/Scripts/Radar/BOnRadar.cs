...
public class BOnRadar : MonoBehaviour {
    ...
    void Update()
    {
        ...
        // disable all markers
        this.IconGO.gameObject.SetActive(this.turnOn[(int)BOnRadar.turnOnIndex.IconGO]);
        this.IconCloseGO.gameObject.SetActive(this.turnOn[(int)BOnRadar.turnOnIndex.IconCloseGO]);
        this.IconOutsideViewGO.gameObject.SetActive(this.turnOn[(int)BOnRadar.turnOnIndex.IconOutsideViewGO]);
        this.hpBarGO.gameObject.SetActive(this.turnOn[(int)BOnRadar.turnOnIndex.hpBarGO]);
        this.IconOutOfSightGO.gameObject.SetActive(this.turnOn[(int)BOnRadar.turnOnIndex.IconOutOfSightGO]);
    }
